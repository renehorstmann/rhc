...
static const char *rhc__hashmap_string_key_clone(const char *key, RhcAllocator_i a) {
...
static void rhc__hashmap_string_key_kill(const char *key, RhcAllocator_i a) {
